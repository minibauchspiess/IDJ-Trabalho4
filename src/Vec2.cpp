...
//Returns the inclination of the vector
float Vec2::Inc(Vec2 v1){
    return atan2(-v1.y, v1.x);        //-v1.y because the y axis increases downwards
}

float Vec2::Inc(Vec2 v1, Vec2 v2){
